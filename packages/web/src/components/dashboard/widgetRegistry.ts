...
export const WIDGET_REGISTRY: WidgetDef[] = [
  ...
  { key: 'clients.active_total', titleAr: 'إجمالي المحفظة', description: 'الزبائن الفعّالون ضمن النطاق الحالي', unit: 'count', permission: 'clients.view_list', department: 'الزبائن', defaultSize: 'sm', accent: 'indigo', trendDirection: 'neutral' },
  ...
  { key: 'clients.committed_ratio', titleAr: 'التزام الزبائن', description: 'جودة المحفظة الحالية', unit: 'percent', permission: 'clients.rating.view', department: 'الزبائن', defaultSize: 'sm', accent: 'violet', trendDirection: 'higher-is-better' },
  ...
  { key: 'clients.classification_distribution', titleAr: 'توزيع دورة الحياة', description: 'تركيب المحفظة بين Lead وFOP وOP', unit: 'count', permission: 'clients.view_list', department: 'الزبائن', defaultSize: 'lg', kind: 'donut', accent: 'indigo' },
  ...
  { key: 'candidates.ownership_breakdown', titleAr: 'توزيع ملكية المرشّحين', description: 'حجم محفظة كل موظف ومعدل تحويلها', unit: 'count', permission: 'candidates.view_list', department: 'الأسماء المقترحة', defaultSize: 'lg', kind: 'ranked-bar', accent: 'sky' },
  ...
  { key: 'clients.water_source_distribution', titleAr: 'مصادر مياه الزبائن', description: 'تركيبة المحفظة حسب مصدر المياه', unit: 'count', permission: 'clients.view_list', department: 'الزبائن', defaultSize: 'lg', kind: 'donut', accent: 'sky' },
];
