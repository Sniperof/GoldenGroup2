...
import { AlertCircle, CalendarClock, CheckCircle2, Clock, Loader2, MapPin, PackageX, Route, Truck } from 'lucide-react';
...
export default function DeviceDeliveryResultModal({
  ...
  return (
    <Modal
      ...
      onClose={onClose}
      size="3xl"
      title={<span className="flex items-center gap-2"><Truck className="h-5 w-5 text-sky-600" />تسجيل نتيجة تسليم الجهاز</span>}
      footer={
        <>
