...
function Divider() {
  return <div className="h-px bg-slate-100 my-4"></div>;
}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Card>
            ...
            <div className="space-y-3">
              ...
              {(data.maintenancePlan || data.warrantyMonths || data.deviceStatus) && <div className="h-px bg-slate-100"></div>}
          ...
          >
            ...
            {approvalError.issues.length > 0 && (
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-3 mb-4">
                ...
                <ul className="text-base text-amber-900 space-y-1 list-disc pr-5 leading-relaxed">
            ...
            {approvalError.detail && (
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-3 mb-4">
                <p className="text-xs font-bold text-slate-500 mb-1">التفاصيل الفنية</p>
                <p className="text-xs text-slate-700 font-mono break-all leading-relaxed">{approvalError.detail}</p>
              </div>
            )}
