...
const PERM_LABELS: Record<string, string> = {
  ...
  'employees.direct_manager_eligible': 'مؤهل كمدير مباشر للقسم',
  'employees.direct_manager_branch_fallback': 'مدير مباشر بديل على مستوى الفرع',
  ...
  'routes.view':                    'عرض خطوط السير',
  'routes.manage':                  'إدارة خطوط السير',
  'routes.assign.view':             'عرض توزيع المسارات',
  'routes.assign.manage':           'إدارة توزيع المسارات',
