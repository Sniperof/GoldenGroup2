...
const CATEGORIES: CategoryMeta[] = [
  ...
  {
    id: 'name_nomination_item_exclusion_reasons',
    label: 'أسباب استبعاد الأسماء المرشحة',
    description: 'قائمة الأسباب الملزمة عند استبعاد اسم واحد أو مجموعة أسماء من طلب ترشيح.',
    impact: 'high',
    usedIn: [{ label: 'مراجعة طلب ترشيح الأسماء', route: 'الطلبات ← ترشيح الأسماء ← التفاصيل', icon: <ClipboardList className="w-3 h-3" /> }],
  },
  {
    id: 'service_request_rejection_name_nomination',
    label: 'أسباب رفض طلب ترشيح الأسماء',
    description: 'أسباب رفض الطلب كاملاً قبل اتخاذ أي قرار على أسمائه.',
    impact: 'high',
