...
| لديه جهاز مركّب / حالة الجهاز | `installed_devices` | ثنائية/ثابتة |
| ضمان ذهبي فعّال | `is_golden_warranty` | ثنائية |
| سبب الإلغاء | `cancellation_reason` | بحث (نصّ حرّ — قيد جودة بيانات) |
