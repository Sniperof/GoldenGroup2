...
> **تحديث 2026-07-30:** حُسم اتجاه المنتج والتنفيذ في [DEC-015](../decisions/DEC-015-layered-planning-curation.md) و[خطة التنقية ذات الطبقات](2026-07-30-layered-planning-curation-plan.md). يبقى ما يلي سجلاً تشخيصياً مفيداً، لكن العقد الحاكم الآن هو صف `(زبون+موقع+D)` بمهام متداخلة، فلاتر خادمية، ثلاث طبقات، واختيار/معاينة/تطبيق ذري. لا تُنفذ تقديرات أو حلول هذا الملف إذا تعارضت مع المرجعين الجديدين.
