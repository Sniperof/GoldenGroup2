...
- الإلغاء المباشر ينقلها إلى `cancelled` في مرحلة الإغلاق، ويلزم سبباً من فئة `system_lists` نفسها المستخدمة لرفض نتيجة ذلك النوع.
...
- [ ] فئة سبب إلغاء ما قبل الجدولة تطابق فئة رفض نتيجة النوع.
