...
> **الحالة:** مسودة توصيف — فرع `Authenticate` · **backend الـ auth مكتمل** (م١-٦ + الحذف + صفحة الويب `/account-deletion`) · متبقٍّ: واجهة React للوحة التحكم + سياسة duplicate_flag
