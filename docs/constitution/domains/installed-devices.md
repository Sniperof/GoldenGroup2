...
- **الجداول المرتبطة:**
  ...
  2. `device_installed_parts` *(Phase 5 — ✅ مكتمل)* — تاريخ قطع الغيار المركبة والمستبدلة لكل وحدة.
...
| **Phase 5** | إنشاء `device_installed_parts` | ✅ مكتمل (migration 197, 2026-05-26) |
