...
|---|---|---|---|
| `employees.nav` | إظهار سجلات الموظفين في الدروار | GLOBAL / BRANCH | صلاحية ظهور فقط. لا تمنح قراءة قائمة الموظفين ولا التفاصيل ولا التعديل. |
| `employees.lookup` | قراءة الموظفين داخل الحقول | GLOBAL / BRANCH / ASSIGNED | تستخدم للحقول التشغيلية التي تحتاج اختيار موظف كوسيط أو مسؤول، بدون فتح سجل الموظفين الكامل. |
| `employees.manager_lookup` | قراءة المديرين المباشرين داخل الحقول | GLOBAL / BRANCH | ترجع مرشحي المدير المباشر ضمن فرع وقسم الموظف، ولا تكفي لعرض كل سجلات الموظفين. |
