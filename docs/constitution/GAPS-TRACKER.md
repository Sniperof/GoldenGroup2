...
| | |
|---|---|
| **عدد الثغرات المفتوحة** | 16 |
| **عالية الخطورة** | 4 (GAP-001, GAP-002, GAP-006, GAP-012) |
| **متوسطة** | 8 (GAP-003, GAP-005, GAP-007, GAP-008, GAP-009, GAP-013, GAP-014, GAP-015) |
| **منخفضة** | 4 (GAP-004, GAP-010, GAP-011, GAP-016) |
| **الكيان الأكثر ثغرات** | contracts (6, including dues) / clients (5) / candidates (5) |
